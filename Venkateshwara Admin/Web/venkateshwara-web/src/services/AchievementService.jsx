...
export const addAchievement = async (values) => {
  const payload = {
    Name: values.title,
    Image: values.image,
    Description: values.description,
    AchievementDate: values.date,
    //Category: values.category
    // NewsDate: values.date
  };

  return axios.post(api.SAVE_ACHIEVEMENT_API, payload, {
    headers: {
...
export const getAchievements = async () => {
  ...
  return axios.get(api.GET_ACHIEVEMENTS_API, {
    headers: {
      'Content-Type': 'application/json',
      // 'userId': storage.getItem("userId")
    }
...
export const deleteAchievement = async (id) => {
  ...
  return axios.delete(api.DELETE_ACHIEVEMENT_API, {
