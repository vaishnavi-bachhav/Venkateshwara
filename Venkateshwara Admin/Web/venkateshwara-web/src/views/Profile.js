                            ...
                            <div className="card">
                                <div className="card-header p-2">
                                    <ul className="nav nav-pills">
                                        ...
                                        <li className="nav-item"><a className="nav-link" href="#timeline" data-toggle="tab">Timeline</a>
                                        </li>
                                        <li className="nav-item"><a className="nav-link" href="#settings" data-toggle="tab">Settings</a>
                                        </li>
                                    </ul>
                                </div>
                                <div className="card-body">
                                    <div className="tab-content">
                                        <div className="active tab-pane" id="activity">
                                            <div className="post">
                                                <div className="user-block">
                                                    <img className="img-circle img-bordered-sm"
                                                        src="assets/dist/img/user1-128x128.jpg" alt="user image" />
                                                    <span className="username">
                                                        <a href="#">Jonathan Burke Jr.</a>
                                                        <a href="#" className="float-right btn-tool"><i
                                                ...
                                                <p>
                                                    ...
                                                    <a href="#" className="link-black text-sm"><i className="far fa-thumbs-up mr-1"></i>
                                                        Like</a>
                                            ...
                                            <div className="post clearfix">
                                                <div className="user-block">
                                                    <img className="img-circle img-bordered-sm"
                                                        src="assets/dist/img/user7-128x128.jpg" alt="User Image" />
                                                    <span className="username">
                                                        <a href="#">Sarah Ross</a>
                                                        <a href="#" className="float-right btn-tool"><i
                                                            className="fas fa-times"></i></a>
                                            ...
                                            <div className="post">
                                                ...
                                                <div className="row mb-3">
                                                    ...
                                                    <div className="col-sm-6">
                                                        <div className="row">
                                                            <div className="col-sm-6">
                                                                <img className="img-fluid mb-3" src="assets/dist/img/photo2.png"
                                                                    alt="Photo" />
                                                                <img className="img-fluid" src="assets/dist/img/photo3.jpg"
                                                                    alt="Photo" />
                                                            </div>
                                                            <div className="col-sm-6">
                                                                <img className="img-fluid mb-3" src="assets/dist/img/photo4.jpg"
                                                                    alt="Photo" />
                                                                <img className="img-fluid" src="assets/dist/img/photo1.png"
                                                                    alt="Photo" />
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="timeline timeline-inverse">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="timeline-item">
                                                        ...
                                                        <h3 className="timeline-header"><a href="#">Support Team</a> sent you an
                                                            email</h3>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="timeline-item">
                                                        ...
                                                        <h3 className="timeline-header"><a href="#">Jay White</a> commented on your
                                                            post</h3>
